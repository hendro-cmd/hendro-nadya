    ...
    <style>
        ...
        * {
        ...
        .bg::after {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 50% 20%, rgba(210, 170, 87, .12), transparent 60%),
...
<body>
    ...
    <div class="cover" id="cover">
        <div class="cover-inner">
            ...
            <div class="cover-names">Nama Pria & Nama Wanita</div>

            <div class="cover-sub">
                Sabtu, 12 Januari 2026<br>
        ...
        <section class="page">
            <div class="card from-left" data-animate="page">
                <div class="hero stagger">
                    ...
                    <div class="names">Nama Pria & Nama Wanita</div>
            ...
            <div class="card from-left" data-animate="page">
                <div class="inner stagger">
                    ...
                    <div class="item">
                        ...
                        Sabtu, 12 Januari 2026 — 09.00 WIB
                    </div>

                    <div class="item">
                        <div class="label">Resepsi</div>
                        Sabtu, 12 Januari 2026 — 11.00 WIB
                    </div>
            ...
            <div class="card from-right" data-animate="page">
                <div class="inner stagger">
                    ...
                    <div class="item">
                        ...
                        Pendopo / Gedung Serbaguna Bahagia
                    </div>

                    <div class="item">
                        <div class="label">Alamat</div>
                        Jl. Contoh Alamat No. 10, Jakarta
                    </div>

                    <a class="btn" target="_blank" href="https://maps.google.com">
                        Petunjuk Ke Lokasi
                    </a>
                </div>
            </div>
        ...
        <section class="page">
            <div class="card from-left" data-animate="page">
                <div class="inner stagger">
                    ...
                    <div class="gallery">
                        <img src="https://images.unsplash.com/photo-1523438097201-512ae7d59b1b?auto=format&fit=crop&w=800&q=60" alt="Foto 1">
                        <img src="https://images.unsplash.com/photo-1529634806980-85c3dd6d34ac?auto=format&fit=crop&w=800&q=60" alt="Foto 2">
                        <img src="https://images.unsplash.com/photo-1523437237164-d442d57cc3c9?auto=format&fit=crop&w=800&q=60" alt="Foto 3">
                        <img src="https://images.unsplash.com/photo-1526045478516-99145907023c?auto=format&fit=crop&w=800&q=60" alt="Foto 4">
                    </div>
